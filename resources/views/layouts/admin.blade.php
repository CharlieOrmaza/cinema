...
{{--El packete auth nos brinda el metodo user, que nos brinda acceso que tiene el usuario y en esta parte imprimimos el nomnre
                   ...
                   {!!Auth::user()->name!!}
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="http://empresariovirtual.com.ve/agarcia"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li><a href="https://facebook.com/aleprog"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
